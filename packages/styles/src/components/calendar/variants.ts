...
export const calendarVariants = tv({
	slots: {
		...
		gridHeaderCell: "pb-md text-sm text-subtle-foreground",
		iconButton: buttonVariants({ variant: "ghost", size: "icon" }),
		cell: [
			"relative -m-px mb-sm flex size-9 text-foreground items-center justify-center rounded-md text-center text-sm",
			focusRing(),
			"data-[selected]:bg-primary data-[selected]:text-primary-foreground data-[unavailable]:text-destructive data-[unavailable]:line-through [&[data-outside-month]]:hidden data-[disabled]:text-subtle-foreground-disabled",
