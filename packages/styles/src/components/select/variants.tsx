...
export const selectVariants = tv({
	slots: {
		...
		item: "relative m-md flex cursor-default flex-col rounded-md p-sm outline-none ring-focus ring-offset-background aria-selected:!bg-primary aria-selected:!text-primary-foreground data-[focus-visible]:border-transparent data-[focus-visible]:bg-background data-[hovered]:bg-subtle data-[focus-visible]:ring-2 data-[hovered]:aria-selected:bg-primary data-[focus-visible]:aria-selected:ring-offset-2",
		value: "text-sm",
