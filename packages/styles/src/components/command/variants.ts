...
export const commandVariants = tv({
	slots: {
		command: "max-w-[425px] overflow-y-auto overflow-x-hidden",
		...
		group: "flex flex-col gap-md overflow-hidden [&_[slot=title]]:px-lg [&_[slot=title]]:pt-md [&_[slot=title]]:text-xs [&_[slot=title]]:text-subtle-foreground",
	},
})
