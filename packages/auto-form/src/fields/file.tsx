...
export default function AutoFormFile({
	...
	return (
		<FormItem>
			...
			{file && (
				<div className="flex h-[40px] w-full flex-row items-center justify-between space-x-2 rounded-sm border p-2 text-black dark:bg-white dark:text-black dark:focus-visible:ring-0 focus-visible:ring-0 dark:focus-visible:ring-offset-0 focus-visible:ring-offset-0">
					<p>{fileName}</p>
